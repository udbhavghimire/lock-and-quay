...
$mail->Host = 'mail.lockquay.ca'; // Specify main and backup SMTP servers
$mail->SMTPAuth = true; // Enable SMTP authentication
$mail->Username = 'info@lockquay.ca'; // SMTP username
$mail->Password = 'mail@lockquay'; // SMTP password
$mail->SMTPSecure = 'tls'; // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587; // TCP port to connect to

$mail->setFrom('info@lockquay.ca', $_POST['name']);
...
$mail->Subject = "Lock and Quay - Landing Page Inquiry";
$message = '
